...
#   times = pd.date_range('2014-01-01', periods=l, freq='1d')
    ...
    ax3.plot(df.index, range(len(df.index)))
    ...
    #
    # # fill color
    # # ax3.fill_between(df.index, rsi_data, 70, where=(rsi_data>=70), facecolor=style.rsi_overbought_color)
